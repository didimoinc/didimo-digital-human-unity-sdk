...
namespace Unity.Netcode
{
    ...
    public abstract class DidimoBufferedLinearInterpolator<T> where T : struct
    {
    ...
    /// </remarks>
    public class DidimoBufferedLinearInterpolatorFloat : DidimoBufferedLinearInterpolator<float>
    {
        /// <inheritdoc />
    ...
    /// </remarks>
    public class DidimoBufferedLinearInterpolatorQuaternion : DidimoBufferedLinearInterpolator<Quaternion>
    {
        /// <inheritdoc />
