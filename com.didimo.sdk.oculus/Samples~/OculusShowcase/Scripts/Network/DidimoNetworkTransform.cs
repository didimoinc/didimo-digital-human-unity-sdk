...
namespace Unity.Netcode.Components
{
    ...
    public class DidimoNetworkTransform : NetworkBehaviour
    {
        ...
        private DidimoBufferedLinearInterpolator<Quaternion> m_RotationInterpolator; // = new BufferedLinearInterpolatorQuaternion(); // rotation is a single Quaternion since each euler axis will affect the quaternion's final value
        ...
        private readonly List<DidimoBufferedLinearInterpolator<float>> m_AllFloatInterpolators = new List<DidimoBufferedLinearInterpolator<float>>(6);
        ...
        private void Awake()
        {
            ...
            m_RotationInterpolator = new DidimoBufferedLinearInterpolatorQuaternion(); // rotation is a single Quaternion since each euler axis will affect the quaternion's final value
