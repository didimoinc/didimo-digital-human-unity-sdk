...
public class MainMenu : MonoBehaviour
{
    ...
    private void LoadSceneWithTransition(string level) => SceneFade.FadeOut(faderPrefab, transitionTime, () => SceneManager.LoadScene(level));

    private void LoadSceneWithTransition(int level) => SceneFade.FadeOut(faderPrefab, transitionTime, () => SceneManager.LoadScene(level));
}