...
using UnityEngine;
/// <summary>
/// Class that has all the functions that trigger animations and the speech solutions for each didimo in the Meet a didimo scene.
/// Its execution is called on the ManageSpeakVRSC script.
/// </summary>
namespace Didimo
{
    public class MeetADidimoVRSC : MonoBehaviour
    {
        [SerializeField]
