...
{   
    ...
    public class Hair : Deformable
    {
        ...
        public Color Color
        {
            get
            {
                return innerHairLayer != null ? innerHairLayer.color : outerHairLayer != null ? outerHairLayer .color : Color.white;
            }
        ...
        {
            void OnPropertyBlock(MaterialPropertyBlock propertyBlock, Component callingComponent, Renderer renderer, Material mat)
            {
            ...
            MaterialBuilder.ProcessPropertyBlocksInHierarchy(DidimoComponents != null ? DidimoComponents.transform : transform, this, OnPropertyBlock);
        }
        ...
        readonly string[] testOuterLayerStrings = { "cards", "fringe", "outer" };
        private void ApplyHairPropertiesToHierarchy()
        {
            void OnPropertyBlock(MaterialPropertyBlock propertyBlock, Component callingComponent, Renderer render, Material currentMaterial)
            {
                ...
                {
                    if ((matname.IndexOf(s, System.StringComparison.OrdinalIgnoreCase) >= 0) || (rendername.IndexOf(s, System.StringComparison.OrdinalIgnoreCase) >= 0))
                    {
                        outer = true;
                        break;
                    }
