# GLTF Importer Unity
This is an importer of GLTF modes for Unity. It imports the models with textures, blendshapes, animations. It is a fork of [GLTFUtility](https://github.com/Siccity/GLTFUtility/).
