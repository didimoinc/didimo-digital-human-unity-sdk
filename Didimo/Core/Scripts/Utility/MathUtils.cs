...
namespace Didimo.Core.Utility
{
    ...
    {
        public static Vector3[] CalculateRectPoints(Matrix4x4 mattransform, Vector3 offset, Rect bounds)
        {
            Vector3[] ret =
            {
        ...
        public static Vector3 GetAveragePoint(Vector3[] pts)
        {
        ...
        public static void CalculateLeastSquares(
            out Vector3 vector,
            out Vector3 offset,
            in Transform[] transforms,
            in Transform MainTransform,
            int noffset)
        {
