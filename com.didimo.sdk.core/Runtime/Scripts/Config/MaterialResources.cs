...
{
    [CreateAssetMenu(fileName = "MaterialResources", menuName = "Didimo/Material Resources")]
    public class MaterialResources : ScriptableObject
    {
        ...
        public Material SkinMergedTextures;
        public Material SkinMergedAtlasedTextures;
        public Material Mouth;
        public Material Eyelash;
        [FormerlySerializedAs("PBRTransparent")] 
        public Material EyelashTransparent;
        public Material UnlitTexture;
        public Material BasicPBRLitShader;
        public Material Hair;
        public Material HairOpaque;
        public Material HairMSAA;
        ...
        public Material GetMaterial(DidimoParts.BodyPart bpid, EShaderType shaderType)
        {
            switch (bpid)
            {
